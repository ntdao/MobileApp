...
public class Mode5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Mode5.this, ListDevice.class));
    ...
    private void switchStatus(String status) {
        ...
        Call<SwitchResponse> call = ApiService.apiService.switchLight5(request);
        call.enqueue(new Callback<>() {
            @Override
            public void onResponse(Call<SwitchResponse> call, Response<SwitchResponse> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(Mode5.this, response.body().toString(), Toast.LENGTH_SHORT).show();
                } else {
                    // Xử lý lỗi đăng nhập
                    Toast.makeText(Mode5.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<SwitchResponse> call, Throwable t) {
                ...
                Toast.makeText(Mode5.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}